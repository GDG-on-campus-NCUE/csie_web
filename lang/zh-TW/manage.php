...
return [
    ...
    'attachments' => [
        ...
        'index' => [
            ...
            'filters' => [
                ...
                'apply' => '套用',
                'reset' => '重設',
                'visibility_all' => '全部可見性',
                'visibility_label' => '可見性篩選',
                'space_label' => '綁定空間',
                'space_all' => '全部空間',
                'tag_label' => '標籤篩選',
                'tag_all' => '全部標籤',
                'keyword_label' => '搜尋附件',
                'keyword_placeholder' => '搜尋附件名稱或檔名',
                'type_label' => '附件類型',
                'type_all' => '全部類型',
                'from' => '起始日期',
                'to' => '結束日期',
                'sort_label' => '排序方式',
                'direction_label' => '排序方向',
                'direction' => [
                    'asc' => '昇冪',
                    'desc' => '降冪',
                ],
        ...
        'bulk' => [
            ...
            'download' => '批次下載',
            'delete' => '批次刪除',
            'confirm_download_title' => '確認批次下載',
            'confirm_delete_title' => '確認批次刪除',
            'confirm_download_description' => '將開啟所有選取附件的下載連結，是否繼續？',
            'confirm_delete_description' => '將永久刪除所有選取的附件，此動作無法還原，是否繼續？',
            'download_success' => '已開啟所有下載連結。',
            'delete_success' => '已批次刪除附件。',
            'delete_error' => '批次刪除失敗。',
        ],
        'selection' => [
            'count' => '已選擇 :count 筆附件',
        ...
        'detail' => [
            'title' => '附件詳情',
            'description' => '檢視檔案中繼資料、關聯資源與存取資訊。',
            'type' => '檔案類型：:type',
            'size' => '檔案大小：:size',
            'visibility' => '可見性：:visibility',
            'uploaded_at' => '上傳時間：:time',
            'attachable_title' => '關聯資源',
            'download' => '下載原始檔案',
            'view_external' => '檢視外部連結',
        ],
        'empty' => [
            'title' => '尚無附件',
            'description' => '還沒有任何可供管理的附件資源。',
        ],
        'description' => '集中管理公告所使用的媒體與文件，支援批次操作與行動版卡片檢視。',
    ],
    'messages' => [
    ...
    'users' => [
        'description' => '集中管理系統帳號的角色、權限與狀態。',
        'filters' => [
            'title' => '篩選條件',
            'keyword_label' => '搜尋使用者',
            'keyword_placeholder' => '搜尋姓名或 Email',
            'roles' => '角色',
            'roles_all' => '全部角色',
            'roles_selected' => '已選 :count 個角色',
            'space_label' => '所屬空間',
            'space_all' => '全部空間',
            'sort_label' => '排序方式',
            'direction' => [
        ...
        'bulk' => [
            'actions' => '批次操作',
            'no_selection' => '尚未選擇任何使用者',
            'selected_count' => '已選擇 :count 筆',
            'activate' => '啟用選取帳號',
            'deactivate' => '停用選取帳號',
            'confirm_activate_title' => '確認啟用',
            'confirm_deactivate_title' => '確認停用',
            'confirm_activate_description' => '將啟用所有選取的帳號，是否繼續？',
            'confirm_deactivate_description' => '將停用所有選取的帳號，是否繼續？',
            'success' => '批次狀態已更新。',
            'title' => '選擇批次動作',
        ],
        'list' => [
            'title' => '帳號列表',
            'subtitle' => '檢視成員資訊並快速調整權限。',
        ],
        'stats' => [
            'total_on_page' => '本頁 :count 筆',
            'active_count' => '啟用帳號：:count',
            'space_memberships' => 'Space 關聯數：:count',
        ],
        'table' => [
            'name' => '姓名',
            'email' => '電子郵件',
            ...
            'never_login' => '尚未登入',
            'no_spaces' => '尚未綁定',
            'spaces_count' => 'Space 數：:count',
            'owner' => '負責人',
            'pagination_summary' => '顯示 :from-:to，共 :total 筆',
        ],
        'actions' => [
            'view_detail' => '檢視詳細資料',
            'send_reset' => '寄送重設密碼',
        ...
        'detail' => [
            'title' => '使用者詳情',
            'description' => '檢視使用者基本資料、角色與活動紀錄。',
            'loading' => '載入中...',
            'save_success' => '使用者設定已更新。',
            'actions' => [
                'cancel' => '取消',
                'save' => '儲存變更',
                'saving' => '儲存中...',
            ...
            'no_spaces_selected' => '尚未選擇任何空間。',
            'no_activities' => '尚無操作紀錄。',
        ],
        'empty' => [
            'title' => '尚無使用者資料',
            'description' => '您可以從右上角邀請新成員或稍後再試。',
        ],
        'invite' => '邀請新成員',
    ],
    'staff' => [
