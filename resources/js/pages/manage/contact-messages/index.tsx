...
export default function ContactMessagesIndex() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: t('sidebar.admin.messages'), href: '/manage/contact-messages' },
    ];

    return (
        <ManageLayout breadcrumbs={breadcrumbs}>
            <Head title={t('sidebar.admin.messages')} />

            <ManagePageHeader
                title={t('sidebar.admin.messages')}
                description="管理使用者聯絡訊息和意見回饋"
                badge={{ label: "聯絡中心" }}
            />
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <div className="text-center py-12">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">聯絡訊息管理功能開發中</h3>
