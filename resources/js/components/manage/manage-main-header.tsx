...
export default function ManageMainHeader({ title, description, breadcrumbs, actions, toolbar }: ManageMainHeaderProps) {
    ...
    return (
        <div className="flex w-full flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 rounded-xl border border-neutral-200/60 bg-white/70 p-6 shadow-sm backdrop-blur-sm">
