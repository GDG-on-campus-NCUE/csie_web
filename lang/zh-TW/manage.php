...
return [
    ...
    'attachments' => [
        ...
        'index' => [
            ...
            'filters' => [
                ...
                'uploaded_by' => '上傳者 ID',
                'uploaded_by_placeholder' => '輸入使用者 ID',
                'created_from' => '起始日期',
                'created_to' => '結束日期',
                'trashed' => '刪除範圍',
                'active_only' => '僅顯示現存',
    ...
    'users' => [
        'index' => [
            'title' => '使用者管理',
            'description' => '檢視並管理後台帳號、角色與狀態。',
            'filters' => [
                'search' => '搜尋使用者',
                'search_placeholder' => '輸入姓名或電子郵件',
                'role' => '角色',
                'role_all' => '全部角色',
                'status' => '狀態',
                'status_all' => '全部狀態',
        ...
        'edit' => [
            'title' => '編輯使用者',
            'deleted_notice' => '此帳號位於回收桶，可於列表頁還原。',
        ],
        'form' => [
            'name' => '姓名',
            'role' => '角色',
            ...
            'locale' => '介面語系',
            'password' => '密碼',
            'password_optional' => '新密碼（選填）',
            'password_confirmation' => '確認密碼',
            'email_verified' => '標記為已驗證',
            'cancel' => '取消',
            'submit_create' => '建立帳號',
            'submit_edit' => '儲存變更',
        ],
