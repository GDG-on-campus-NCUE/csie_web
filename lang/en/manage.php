...
return [
    ...
    'attachments' => [
        ...
        'index' => [
            ...
            'filters' => [
                ...
                'uploaded_by_placeholder' => 'Enter user ID',
    ...
    'users' => [
        'index' => [
            ...
            'description' => 'Review and manage back-office accounts, roles, and statuses.',
            'filters' => [
                'search' => 'Search users',
                ...
                'created_from' => 'Created from',
                'created_to' => 'Created to',
                'trashed' => 'Record scope',
                'trashed_active' => 'Active only',
        ...
        'edit' => [
            'title' => 'Edit user',
            'deleted_notice' => 'This account is in the recycle bin and can be restored from the listing.',
        ],
        'form' => [
            'name' => 'Name',
            'role' => 'Role',
            ...
            'email_verified' => 'Mark as verified',
            'cancel' => 'Cancel',
